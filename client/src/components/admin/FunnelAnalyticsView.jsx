...
const STEP_LABELS = {
    ...
    waiting_ok: 'OK', waiting_zone: 'Zona', waiting_data: 'Datos',
...
const STEP_ORDER = [
    ...
    'waiting_price_confirmation', 'waiting_ok', 'waiting_zone', 'waiting_data',
...
const STEP_EXPLAIN = {
    ...
    waiting_zone: 'El bot preguntó de qué localidad es para decidir reparto propio o Correo.',
    ...
    waiting_payment_method: 'Eligiendo envío y forma de pago (fuera de zona, prepago).',
