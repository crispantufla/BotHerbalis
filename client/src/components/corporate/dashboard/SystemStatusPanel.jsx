...
const SystemStatusPanel = ({ status, activeConversations = 0, adminNumbers = [], onAddPhone, onRemovePhone, onRegenerateQR }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl border border-slate-200/60 dark:border-slate-700/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col relative overflow-hidden group">
            {/* Background glow */}
            ...
            <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-200/60 dark:border-slate-700/60 bg-slate-50/60 dark:bg-slate-800/40">
                <h3 className="font-extrabold text-slate-800 dark:text-slate-100 text-sm uppercase tracking-widest">Sistema</h3>
            </div>

            <div className="p-4 sm:p-6 flex-1 flex flex-col gap-4 sm:gap-8 relative z-10">
                {/* Connection Status */}
