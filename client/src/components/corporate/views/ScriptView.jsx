                                                ...
                                                <div className="mt-4 space-y-4 animate-fade-in border-t border-gray-100 pt-4">
                                                    ...
                                                    <div className="border-t border-gray-100 pt-4 mt-2">
                                                        <label className="flex items-center gap-2 cursor-pointer group">
                                                            ...
                                                            />
                                                            <span className="text-xs font-bold text-gray-500 group-hover:text-gray-700 uppercase tracking-wide">
                                                                ...
                                                                {step.image ? (
                                                                    <div className="relative inline-block">
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="absolute -top-2 -right-2 w-6 h-6 bg-red-500 text-white rounded-full text-xs font-bold hover:bg-red-600 shadow-md flex items-center justify-center"
                                                                            title="Quitar imagen"
                                                                        >
                                                                            ✕
                                                                        </button>
