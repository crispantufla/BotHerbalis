...
**PENDIENTE:** commit (+ push/deploy si el usuario confirma). Riesgos residuales anotados en Batch C (audios viejos públicos; verificar cuenta role='seller' en prod antes de regenerar instalador del agente).
