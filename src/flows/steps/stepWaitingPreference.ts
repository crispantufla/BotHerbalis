...
export async function handleWaitingPreference(
    ...
    if (isComparison) {
        ...
        const aiRecommendation = await aiService.chat(text, {
            ...
            6) Si pregunta por envío o medios de pago, aclara con amabilidad que el envío es gratis a todo el país y que el pago se hace por *Mercado Pago* — cubre tarjeta de crédito (en cuotas), débito, saldo MP y efectivo en Pago Fácil/Rapipago. NO menciones contra reembolso ni transferencia espontáneamente: solo si el cliente los pide. Luego preguntale con cuál producto prefiere avanzar.
