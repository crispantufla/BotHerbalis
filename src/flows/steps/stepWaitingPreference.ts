...
export async function handleWaitingPreference(
    ...
    if (isComparison) {
        ...
        const aiRecommendation = await aiService.chat(text, {
            ...
            6) Si pregunta por envío o medios de pago, aclara con amabilidad que el envío es gratis a todo el país y que tenemos 3 formas de pagar (link de Mercado Pago para tarjeta de crédito o débito, transferencia bancaria al alias, o contra reembolso con anticipo de $10.000). NUNCA menciones cuotas. Luego preguntale con cuál producto prefiere avanzar.
...
7) Si pregunta por envío o medios de pago, aclará de forma cálida que el envío es gratis a todo el país, y que tenemos 3 opciones de pago: Mercado Pago (recomendado — cubre tarjeta, débito y efectivo en Pago Fácil), transferencia bancaria, o contra reembolso con anticipo de $10.000. NUNCA digas "solo efectivo al recibir". Si pregunta por horarios, aclará que no tenemos control sobre los carteros de Correo Argentino pero que avisamos si no lo encuentran. Luego preguntale con cuál producto prefiere avanzar.
