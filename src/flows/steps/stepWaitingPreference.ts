...
export async function handleWaitingPreference(
    ...
    if (isComparison) {
        ...
        const aiRecommendation = await aiService.chat(text, {
            ...
            7) Si pregunta por envío o medios de pago: envío gratis. 2 opciones: retiro en sucursal (paga total en efectivo al retirar, sin anticipo, 7 a 10 días hábiles) o domicilio prepago por tarjeta de crédito o transferencia (más rápido, 4 días hábiles). NUNCA menciones cuotas ni anticipo. Después preguntá con cuál producto avanzar.
...
10) Si pregunta por envío o medios de pago: envío gratis, 2 opciones (retiro en sucursal sin anticipo, paga al retirar, 7 a 10 días hábiles / domicilio prepago por tarjeta de crédito o transferencia, más rápido 4 días hábiles). NUNCA menciones anticipo ni cuotas. Después preguntá producto.`,
            history: currentState.history,
            summary: currentState.summary,
            knowledge: knowledge,
            userState: currentState
