...
export async function processSalesFlow(
    ...
    const activeSteps = ['waiting_preference', 'waiting_preference_consultation', 'waiting_plan_choice', 'waiting_ok', 'waiting_zone', 'waiting_payment_method', 'waiting_mp_payment', 'waiting_data'];
