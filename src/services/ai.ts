...
const RULE_BASE = [
    ...
    { id: 'posterga', keywords: ['luego te aviso', 'despues te digo', 'te confirmo', 'lo pienso', 'mas tarde', 'en un rato'], text: 'POSTERGACIÓN — distinguí 2 casos: (A) "No puedo hablar ahora / estoy trabajando / en un rato" → back-off real: "Dale, cuando puedas me escribís 😊", sin preguntas, goalMet=false. (B) Postergar la COMPRA ("lo pienso", "te aviso", "cuando cobre", "más adelante") → NO te rindas a la primera: ofrecé postdatar UNA sola vez: "¡Tranqui! Te lo agendo y lo despacho la fecha que te quede cómoda. ¿A partir de qué día te queda bien recibirlo?". Si dan fecha → extraé POSTDATADO y seguí cerrando. Si vuelven a postergar o dicen que no → recién ahí soltá: "Dale, cuando quieras retomamos 😊", goalMet=false. PROHIBIDO mencionar "congelar precio".' },
    ...
    { id: 'medios_pago', keywords: ['qr', 'mercadopago', 'mercadolibre', 'transferencia', 'debito', 'credito', 'cbu', 'alias', 'tarjeta'], text: 'MEDIOS DE PAGO (modelo nuevo may-2026): Hay 2 tipos de envío y según cuál elija, los medios son distintos. (A) *Retiro en sucursal* → contrarreembolso: el cliente paga el TOTAL en efectivo cuando va a la sucursal de Correo Argentino. Sin anticipo, sin transferencia previa. (B) *Envío a domicilio* → prepago, antes de despachar. Las opciones de prepago son: (1) *Mercado Pago* — link inmediato, cubre tarjeta de crédito, débito, app MP, o efectivo en Pago Fácil/Rapipago con el código; (2) *Transferencia bancaria* al alias *HERBALIS.TIENDA* a nombre de *BIO ORIGEN S.A.S.* por el monto total. Ambos envíos son GRATIS. NUNCA menciones "anticipo de $10.000" — esa modalidad fue eliminada en mayo 2026. NUNCA menciones cuotas (lo que la tarjeta permita lo verá el cliente al abrir el link de MP). NO inventes CBUs ni titulares distintos al oficial.' },
