...
MEDIOS DE PAGO:
- Ofrecemos 3 opciones espontáneamente: (1) Tarjeta de crédito o débito por Mercado Pago, (2) Transferencia bancaria al alias HERBALIS.TIENDA a nombre de Bio Origen SAS, (3) Contra reembolso con anticipo de $10.000 al mismo alias + saldo en efectivo al cartero.
    ...
    async chat(userText: string, context: APIContext): Promise<AIParsedResponse> {
        ...
        if (context.knowledge && context.knowledge.flow) {
            ...
            if (['waiting_weight', 'waiting_preference'].includes(step)) {
                ...
                knowledgeContext += `- POLÍTICA DE PAGO: 3 opciones espontáneas — (1) link de Mercado Pago para tarjeta de crédito o débito, (2) transferencia bancaria al alias HERBALIS.TIENDA (Bio Origen SAS), (3) contra reembolso con anticipo de $10.000 al mismo alias + saldo en efectivo al cartero. Aplica a TODOS los planes. NUNCA menciones cuotas.\n`;
