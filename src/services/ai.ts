...
const RULE_BASE = [
    ...
    { id: 'medios_pago', keywords: ['qr', 'mercadopago', 'mercadolibre', 'transferencia', 'debito', 'credito', 'cbu', 'alias', 'tarjeta'], text: 'MEDIOS DE PAGO: Ofrecemos 3 opciones cuando el cliente está por elegir cómo paga: (1) *Tarjeta de crédito (en cuotas)* — por Mercado Pago, link inmediato, cubre crédito (cuotas), débito y saldo MP; (2) *Transferencia bancaria* — alias *ERRONEA.HABLAME.LUZ* a nombre de *Bio Origen SAS*, monto total; (3) *Contra reembolso* — anticipo de *$10.000* por transferencia al mismo alias (cubre el envío) + saldo en efectivo al cartero al recibir. La opción 3 aplica a TODOS los planes y a TODOS los clientes. NO menciones "efectivo en Pago Fácil/Rapipago". NO inventes CBUs ni titulares distintos al oficial.' },
