...
const ABANDON_REASON_MESSAGES: Record<string, string[]> = {
    ...
    hesitation: [
        '¡Hola! 😊 Sin apuro. El envío tarda *7 a 10 días hábiles* por Correo Argentino, y más rápido —6 a 7— si lo pagás por adelantado. ¿Avanzamos cuando quieras?',
