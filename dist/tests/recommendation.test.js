...
describe('Product Recommendation Logic', () => {
    ...
    test('Should trigger consultation for "Estoy entre gotas y semillas"', async () => {
        ...
        expect(mockSendMessage).toHaveBeenCalledWith(userId, "AI CONSULTATION RESPONSE");
    ...
    test('Should trigger consultation for "Cual es mejor?"', async () => {
        ...
        expect(mockSendMessage).toHaveBeenCalledWith(userId, expect.any(String));
    ...
    test('Should select CAPSULAS directly if only capsulas mentioned', async () => {
        ...
        expect(mockSendMessage).toHaveBeenCalledWith(userId, expect.stringMatching(/Cápsulas es la mejor opción/i));
    });
    test('Should NOT trigger payment FAQ for address with "pampa"', async () => {
        ...
        expect(mockSendMessage).not.toHaveBeenCalledWith(userId, expect.stringContaining("únicamente con pago al recibir"));
    });
});
