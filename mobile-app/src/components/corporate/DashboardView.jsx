...
const DashboardView = ({ alerts = [], config, handleQuickAction, status, qrData }) => {
    ...
    return (
        <div className="space-y-2 sm:space-y-8 animate-fade-in relative z-10 w-full">
            {/* Header de la vista */}
            <div className="mb-3 sm:mb-8 flex flex-col sm:flex-row sm:justify-between sm:items-stretch gap-2 sm:gap-6 sm:h-[5.5rem]">
                ...
                <button
                    ...
                    className={`flex items-center justify-center gap-2 sm:gap-4 px-3 sm:px-6 py-2 sm:py-0 rounded-[1.25rem] font-bold transition-all shadow-sm w-full sm:w-72 sm:h-full ${isGlobalPause
